...
import logging
import requests
log = logging.getLogger('moodle.api')


class MoodleApi(metaclass=requests.Session):
...
# class MoodleApi31(MoodleApi, MoodleCore, MoodleCoreEnrol, MoodleModAssignments):
#     @abstractmethod
#     def post_web_service(self, function, args):
#         raise NotImplementedError()
